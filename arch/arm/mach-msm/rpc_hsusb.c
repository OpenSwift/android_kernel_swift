...
#define ONRPC_CHG_GET_STATUS_PROC	12
...
int msm_hsusb_detect_chg_type(void)
{
	...
	rc = msm_rpc_call_reply(chg_ep, ONRPC_CHG_GET_STATUS_PROC,
...
#if 0 //def CONFIG_USB_GADGET_MSM_72K
...
/* 2010-02-17, Stablize the IMEI RPC */
...
#define NV_IMEI_GET_VER				0x00060001 /* 0x00020001 */
